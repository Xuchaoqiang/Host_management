...
def distribute_permissions(request):
    ...
    role_object = models.Role.objects.filter(pk=role_id).first()
    if not role_object:
        role_id = None
    ...
    """
    [
        {id:1,title:菜单1,children:[{id:1,title:x1, menu_id:1,'children':[{id:11,title:x2,pid:1},] },{id:2,title:x1, menu_id:1, children:[]},]},
